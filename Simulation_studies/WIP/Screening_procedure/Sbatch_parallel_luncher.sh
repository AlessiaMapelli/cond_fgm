...
JOBS_LIMIT=70
r_script=/group/diangelantonio/users/alessia_mapelli/conditional_neurofgm/Simulation_studies/WIP/Screening_procedure/Sim_1_sbatch_parallel_random_neighboors.R
