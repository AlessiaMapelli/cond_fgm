setwd("/Volumes/diangelantonio/users/alessia_mapelli/conditional_neurofgm/Simulation_studies")
rm(list=ls(all=TRUE))

time.start.tot <- Sys.time()

data.path <- "/Volumes/diangelantonio/users/alessia_mapelli/Brain_simulations/Sim_1"
func.path <- "/Volumes/diangelantonio/users/alessia_mapelli/conditional_neurofgm/Graph_estimation"
save.path <- "/Volumes/diangelantonio/users/alessia_mapelli/Brain_simulations/Sim_1"
runtime.path <- "/Volumes/diangelantonio/users/alessia_mapelli/Brain_simulations/Sim_1"
...
save(G.mat, file = paste(save.path,"res_0204_sequential.RData", sep="/"))
