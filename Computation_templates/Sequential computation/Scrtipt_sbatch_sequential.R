...
scores <- read.csv(paste(data.path, "scores.csv", sep ="/"))[, -1]
cat("score source: ", paste(data.path, "scores.csv", sep ="/"),"\n")
n_basis <- 
...
save(G.mat, file = paste(save.path,"res_name.RData", sep="/"))
cat("Output saved to: ",paste(save.path,"res_name.RData", sep="/"), "\n" )
